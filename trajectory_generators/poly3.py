...
class Poly3(TrajectoryGenerator):
    ...
    def generate(self, t):
        ...
        Positional trajectory should be a 3rd degree polynomial going from an initial state q_0 to desired state q_d.
        ...
        q_dot = (self.a_1 - 3 * self.a_0) + (6 * self.a_0 - 4 * self.a_1 + 2 * self.a_2) * t + (3 * self.a_1 - 3 * self.a_0 - 3 * self.a_2 + 3 * self.a_3) * t**2
        q_ddot = (6 * self.a_0 - 4 * self.a_1 + 2 * self.a_2) + (6 * self.a_1 - 6 * self.a_0 - 6 * self.a_2 + 6 * self.a_3) * t
